...
public class EnemyActionManager : MonoBehaviour
{
    ...
    {
        // find the closest player unit if any exist
        ...
        Tile tile = MoveTowardsTile(targetTile);
        Tile moveTile = tile;
    ...
    {
        // Returns the closest player found
        closestHero = null;
        _ = new List<Tile>();
        List<Tile> tiles;
    ...
    public Tile MoveTowardsTile(Tile targetTile)
    {
            ...
            while ( moveCount < moveValue)
        {
            ...
            tile = tile.parent;
            moveCount++;
            // check if unit arrived back to starting point
